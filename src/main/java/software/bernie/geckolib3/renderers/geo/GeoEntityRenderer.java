...
public abstract class GeoEntityRenderer<T extends LivingEntity & IAnimatable> extends EntityRenderer<T>
    ...
    public GeoEntityRenderer(EntityRendererFactory.Context ctx, AnimatedGeoModel<T> model) {
        super(ctx);
        this.model = model;
    }
    ...
    public void render(T entity, float entityYaw, float partialTicks, MatrixStack stack,
        ...
        GeoModel model = this.model.getGeoModel(this.model.getModelResource(entity));
        this.model.setLivingAnimations(entity, this.getUniqueID(entity), predicate);
