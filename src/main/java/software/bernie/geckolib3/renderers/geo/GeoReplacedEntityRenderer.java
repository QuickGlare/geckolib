...
public abstract class GeoReplacedEntityRenderer<NEW extends IAnimatable, OLD extends LivingEntity> extends EntityRenderer<OLD> implements IGeoRenderer {
    private final AnimatedGeoModel<IAnimatable> model;
    private final NEW animatable;
    ...
    public GeoReplacedEntityRenderer(EntityRendererFactory.Context ctx,
                                     AnimatedGeoModel<IAnimatable> model, NEW animatable) {
        super(ctx);
        this.model = model;
    ...
    @Override
    public void render(OLD entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn,
                       VertexConsumerProvider bufferIn, int packedLightIn) {
        this.render(entityIn, this.animatable, entityYaw, partialTicks, matrixStackIn, bufferIn, packedLightIn);
    }

    @SuppressWarnings({"resource"})
    public void render(OLD entity, IAnimatable animatable, float entityYaw, float partialTicks, MatrixStack stack,
                       VertexConsumerProvider bufferIn, int packedLightIn) {
        ...
        if (model instanceof IAnimatableModel) {
            ((IAnimatableModel) model).setLivingAnimations(animatable, this.getUniqueID(entity), predicate);
        }
    ...
    @Override
    public Identifier getTexture(OLD entity) {
    ...
    @Override
    protected boolean hasLabel(OLD entity) {
    ...
    public Identifier getTextureResource(Object instance) {
        return this.model.getTextureResource((IAnimatable) instance);
    }
